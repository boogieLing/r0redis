...
class Collection(object):
    ...
    Create an instance of `r0redis.Collection` and use the 'add', 'get',
    ...
    def recent_unique_values(self, limit=None):
    ...
    def top_values_for_index(self, index_name, limit=None):
